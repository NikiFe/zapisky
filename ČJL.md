...
graph TD
  ...
  B --> C[1841-1843: Univerzita]
  C --> D[1843-1844: Rusko]
  D --> E[1846: Pražské noviny]
  E --> F[1848: Národní noviny]
  F --> G[1850: Slovan]
  G --> H[1851-1855: Exil]
  H --> I[1856: Smrt]
```
...
```mermaid
graph LR
  KHB[Karel Havlíček] ---|Manželka| JS[Julie Světlá]
  KHB ---|Přítel| BN[Božena Němcová]
  KHB ---|Přítel| KJE[Karel Jaromír Erben]
  KHB ---|Mentor| FP[František Palacký]
  KHB ---|Inspirace| PJS[Pavel Josef Šafařík]
```

```mermaid
graph TD
  KHB[Karel Havlíček] -->|Žurnalistika| A[Moderní publicistika]
  KHB -->|Poezie| B[Politická satira]
  KHB -->|Národní vědomí| C[Svoboda slova]
  A --> D[Masaryk]
  B --> E[Literární tradice]
  C --> F[Demokracie]
```
